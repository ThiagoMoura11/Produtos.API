...
Esta API REST permite o gerenciar os Produtos da sua aplicação, fornecendo operações de CRUD de um Produto. Ela foi desenvolvida utilizando .NET 6.0 e utiliza as tecnologias EF Core e SQLite para persistência de dados.
